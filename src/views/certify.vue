    ...
    <div id="app">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="90px" class="certify_Form">
            ...
            <el-form-item label="保固卡號" prop="warrantyNum">
                <el-input v-model="ruleForm.warrantyNum"></el-input>
            </el-form-item>
            <el-button type="primary" icon="el-icon-search" @click="submitQuery('ruleForm')" >確認</el-button>
        </el-form>
        <el-dialog
                title="客户认证" :visible.sync="certifyInfoVisible" width="90%" top="20px" center>
        <div class="checkForm">
            ...
            <br/>
            <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="check-ruleForm">
                <el-form-item label="車主姓名" prop="owner">
                    <el-input v-model="ruleForm2.owner"></el-input>
                </el-form-item>
                <el-form-item label="性別" prop="gender">
                    <el-select v-model="ruleForm2.gender" placeholder="請選擇車主性別">
                ...
                <el-form-item label="所在城市" prop="city">
                    <el-select v-model="ruleForm2.city" placeholder="請選擇所在城市">
                ...
                <el-form-item label="車輛品牌" prop="brand">
                    <el-select v-model="ruleForm2.brand" placeholder="請選擇車輛品牌">
                ...
                <el-form-item label="車型" prop="vehicleType">
                    <el-select v-model="ruleForm2.vehicleType" placeholder="請選擇車型">
                ...
                <el-form-item label="車牌號碼" prop="vehicleNum">
                    <el-input v-model="ruleForm2.vehicleNum"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" icon="el-icon-check" @click="submitForm('ruleForm2')">認證</el-button>
                    <el-button icon="el-icon-delete"  @click="resetForm('ruleForm2')">重置</el-button>
                </el-form-item>
            </el-form>
        </div>
        </el-dialog>
    ...
    export default {
        ...
        methods:{
            submitQuery(formName) {
                this.PDIData[0] = this.ruleForm;
                this.ruleForm = {};
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.certifyInfoVisible = true;
                    } else {
                        this.$message({
